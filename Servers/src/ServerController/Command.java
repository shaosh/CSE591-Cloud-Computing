...
public class Command {
	...
	public static final String QUERY_ALL_USERID = "query all userid";
	public static final String QUERY_ALL_USERID_SUCCESSFUL = "query all userid successful";
	public static final String GET_SHARED_FILELIST = "get shared filelist";
	public static final String INTERNAL_DELETMITER = "@@";
}
